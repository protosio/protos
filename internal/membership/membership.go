...
func FilterInstances(instances []cloud.InstanceInfo, peerIDs map[string]struct{}) []cloud.InstanceInfo {
	filtered := make([]cloud.InstanceInfo, 0, len(instances))
...
func Machines(instances []cloud.InstanceInfo, devices []user.UserDevice) []p2p.Machine {
