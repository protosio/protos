...
var createInternalRoutes = func(cm core.CapabilityManager) routes {
	return routes{
		route{
			"getOwnResources",
			"GET",
		...
		route{
			...
			registerResourceProvider,
			cm.GetOrPanic("RegisterResourceProvider"),
		},
		route{
			...
			"/provider/{resourceType}",
			deregisterResourceProvider,
			cm.GetOrPanic("DeregisterResourceProvider"),
		},
		route{
			...
			"/resource/provider",
			getProviderResources,
			cm.GetOrPanic("GetProviderResources"),
		},
		route{
			"updateResourceValue",
			"UPDATE",
			"/resource/{resourceID}",
			updateResourceValue,
			cm.GetOrPanic("ResourceProvider"),
		},
		route{
			"setResourceStatus",
			"POST",
			"/resource/{resourceID}",
			setResourceStatus,
			cm.GetOrPanic("SetResourceStatus"),
		},
		route{
			"getResource",
			"GET",
