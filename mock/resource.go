...
import (
	...
	core "github.com/protosio/protos/core"
	reflect "reflect"
)
...
func (m *MockResourceCreator) CreateDNS(appID, name, rtype, value string, ttl int) (core.Resource, error) {
	m.ctrl.T.Helper()
...
func (mr *MockResourceCreatorMockRecorder) CreateDNS(appID, name, rtype, value, ttl interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "CreateDNS", reflect.TypeOf((*MockResourceCreator)(nil).CreateDNS), appID, name, rtype, value, ttl)
}

// CreateCert mocks base method
func (m *MockResourceCreator) CreateCert(appID string, domains []string) (core.Resource, error) {
	m.ctrl.T.Helper()
...
func (mr *MockResourceCreatorMockRecorder) CreateCert(appID, domains interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "CreateCert", reflect.TypeOf((*MockResourceCreator)(nil).CreateCert), appID, domains)
}

// CreateFromJSON mocks base method
func (m *MockResourceCreator) CreateFromJSON(rscJSON []byte, appID string) (core.Resource, error) {
	m.ctrl.T.Helper()
...
func (mr *MockResourceCreatorMockRecorder) CreateFromJSON(rscJSON, appID interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "CreateFromJSON", reflect.TypeOf((*MockResourceCreator)(nil).CreateFromJSON), rscJSON, appID)
}
